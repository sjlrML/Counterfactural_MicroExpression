...
from dataset_config import CASME2_config,SAMM_config,SMIC_config
import pickle
import random
import pdb
...
def get_args():
    ...
    parse.add_argument('--data_root',type=str,default='/data/laolingjie/database/SMIC/HS')
    parse.add_argument('--data_list',type=str,default='/data/laolingjie/database/SMIC/SMIC_HS_my2.xls')
    ...
    parse.add_argument('--train_log',type=str,default='log/CoDer_SMIC_lr5.log')
    parse.add_argument('--save_name',type=str,default='CoDer_SMIC_lr5')
    ...
    parse.add_argument('--classes_num',type=int,default=3)
...
def val(model,val_loader,CELoss,args,epoch):
    ...
    f1 = f1_score(total_label,total_pred,average='micro')*100
...
if __name__ == "__main__":
    ...
    subject_index = SMIC_config["subject_num"]
    ...
    for i_fold,test_subject_index in enumerate(subject_index):
        ...
        train_dataset = SMIC(args.data_root,args.data_list, class_num = args.classes_num,test_subject=test_subject_index,is_dynamic=False,
        ...
        val_dataset = SMIC(args.data_root,args.data_list,class_num = args.classes_num,test_subject=test_subject_index,is_dynamic=False,
        ...
        lr = [0.0005,0.005,0.005,0.005,0.005]
