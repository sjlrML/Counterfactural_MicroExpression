...
class occulsion_net(nn.Module):
    ...
    def forward(self,image):
        ...
        image_output,attn_weights,part_embedding = self.trans(image_feature_embedding)

        # image_output = self.classifier1(part_embedding[:,0])
...
class Trans_Block(nn.Module):
    def __init__(self,transformer_res,config):
        ...
        # self.norm = transformer_res.transformer.encoder.encoder_norm
    ...
    def forward(self, x):
        ...
        return featrue, attn_weights,part_encoded
